...
var AdapterDateFnsBase = class {
  constructor(props) {
    ...
    const {
      locale: locale2,
      formats,
      longFormatters: longFormatters3
    } = props;
    this.locale = locale2;
    this.formats = _extends({}, defaultFormats, formats);
    this.longFormatters = longFormatters3;
  }
};
...
var AdapterDateFns = class extends AdapterDateFnsBase {
  constructor({
    ...
    super({
      locale: locale2 != null ? locale2 : en_US_default,
      formats,
      longFormatters: import_longFormatters3.default
    });
